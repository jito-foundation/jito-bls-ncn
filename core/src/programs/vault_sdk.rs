...
pub fn burn_vault_address(base: &Pubkey) -> (Pubkey, u8, Vec<Vec<u8>>) {
    BurnVault::offchain_find_program_address(&id(), *base)
}

pub fn vault_address(base: &Pubkey) -> (Pubkey, u8, Vec<Vec<u8>>) {
