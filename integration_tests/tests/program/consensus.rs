...
mod tests {
    ...
    use jito_bls_ncn_clients::program_clients::{
        bls_ncn_client::{get_consensus, initialize_consensus}, meta_restaking_client::create_test_ncn,
    };
    ...
    #[tokio::test]
    async fn test_consensus_ok() -> Result<()> {
        ...
        get_consensus(&client, &ncn).await?;
